    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                Welcome to Bus Ticket Booking System, your go-to solution for quick and easy bus ticket booking. Our platform is designed to make your travel planning hassle-free and efficient. Whether you're booking a ticket for a short city ride or a long intercity journey, we've got you covered with a seamless booking experience.
                <br>At Bus Ticket Booking System, we believe in providing convenience and reliability to our customers. With a user-friendly interface and a wide range of bus operators to choose from, you can book your tickets in just a few clicks. Our mission is to simplify the travel process, save you time, and ensure that you have a comfortable and enjoyable journey.               
                <br>Thank you for choosing Bus Ticket Booking System. We look forward to being a part of your travel adventures!
                </p>
            </div>
            <div class="col-md-9 developer-info">
            <div style = "display: flex; justify-content: center;">
                <img src="pic/1.jpg" alt="" style = "border: 2px solid black; border-radius: 50%; width: 200px; height: 200px; position: relative; left: 140px;">
            </div>
            <p>BSIT Programming Student</p>
            <p><strong>Expertise:</strong> Real Estate Management System Development, Full-Stack Web Development</p>
            <p></p>
            <p><strong>Phone:</strong> +63 9317311346</p>
    

            <div class="social-icons" style = "display: flex; justify-content: space-around; position: relative; left: 130px;">
               
                <a href="https://github.com/16PAJO" target="_black"><img src="https://img.icons8.com/ios-filled/50/000000/github.png" class="icon" alt="GitHub"></a>
                <a href="https://www.facebook.com/van.kiezy.1/" target="_black"><img src="https://img.icons8.com/ios-filled/50/000000/facebook.png" class="icon" alt="Facebook"></a>
            </div>
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Bus Ticket Booking System | Made with &#10084;&#65039; by Van Cyrille Pajo
                        </p>
        </footer>
    </div>
